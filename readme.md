...
- iPhone with the App installed Estimote Beacons . The iPhone with the Beacon App installed has the Role of the Beacon, the Transmitter of Advertisement Packets in  the room. 
...
- A Lifx Lamp Color 1000. It has the Role of the AllJoyn Producer. Implments the LSF Framework from Allseen Alliance.  
